...
{
    public class Pinvvoucher : EntityRoot
    {
        ...
        public List<Pmvts> Mvts { get; set; } = new List<Pmvts>();
        public List<CustomersOrders> CustomersOrders { get; set; } = new List<CustomersOrders>();
    } 
}
