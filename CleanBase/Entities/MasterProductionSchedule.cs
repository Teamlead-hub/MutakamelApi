...
{
    public class MasterProductionSchedule : EntityRoot
    {
        ...
        public List<MasterProductionScheduleDet> MasterProductionScheduleDet { get; set; } = new List<MasterProductionScheduleDet>();
    }
}
